...
shows a shorter example then what is shown here. 
...
Here is an example where we use the `mdgc` function to do model estimation 
and imputation:

```{r very_quick_example, cache = 1, eval = FALSE}
